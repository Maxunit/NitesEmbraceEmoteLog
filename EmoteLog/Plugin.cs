...
namespace EmoteLog
{
    public sealed class Plugin : IDalamudPlugin
    {
        ...
        public WindowSystem WindowSystem = new("Nite's Embrace EmoteLog");
        ...
        public Plugin(IDalamudPluginInterface pluginInterface)
        {
            ...
            {
                HelpMessage = $"Opens the Nite's Embrace Emote Log window, \"{CommandName} config\" to open settings and \"{CommandName} clear\" to clear the log"
            });
        ...
        private void OnCommand(string command, string args)
        {
            ...
            {
                PluginServices.ChatGui.PrintError($"[Nite's Embrace Emote Log] Unknown argument: \"{args}\"");
            }
        }
        private void ToggleMainWindow()
        {
            if (!MainWindow.DrawConditions())
            {
                ...
                {
                    PluginServices.ChatGui.Print("[Nite's Embrace Emote Log] Emote Log window opened, but your configuration is currently hiding it.");
                }
                else
                {
                    PluginServices.ChatGui.Print("[Nite's Embrace Emote Log] Emote Log window closed, your configuration was hiding it.");
                }
            }
            MainWindow.Toggle();
        }
